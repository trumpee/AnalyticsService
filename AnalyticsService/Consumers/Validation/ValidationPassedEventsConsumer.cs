...
public class ValidationPassedEventsConsumer(
    IAnalyticsEventsRepository repository,
    ILogger<ValidationPassedEventsConsumer> logger
) : IConsumer<AnalyticsEvent<ValidationPassedPayload>>
{
    public async Task Consume(ConsumeContext<AnalyticsEvent<ValidationPassedPayload>> context)
    {
